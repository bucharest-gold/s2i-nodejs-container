...
This repository contains the source for building Node.js
version 9 [source-to-image](https://github.com/openshift/source-to-image)
builder containers.
...
*  **For RHEL based image**
    ```
    $ s2i build https://github.com/bucharest-gold/s2i-nodejs-container.git --context-dir=9/test/test-app/ bucharestgold/nodejs-9-rhel7 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```

*  **For CentOS based image**
    ```
    $ s2i build https://github.com/bucharest-gold/s2i-nodejs-container.git --context-dir=9/test/test-app/ bucharestgold/nodejs-9-centos7 nodejs-sample-app
    $ docker run -p 8080:8080 nodejs-sample-app
    ```
